// =============================================================================
// Lab 05 — Index & EXPLAIN — Etape 3 : Index avances (Exercice)
// =============================================================================
// Objectifs :
...
const { test, assert, assertEqual, assertGreaterThan, assertLessThan, assertIncludes, summary } = createTestRunner('Lab 05 — Etape 3 : Index avances');
...
try {
  ...
  await test('Comparaison temps Seq Scan vs Index Scan', async () => {
    ...
    // Pour forcer un Seq Scan : SET enable_indexscan = off; SET enable_bitmapscan = off;
    // Pour reactiver : SET enable_indexscan = on; SET enable_bitmapscan = on;
    // Utilisez measure() pour mesurer le temps
    //
    // Indice :
  ...
  await test('Statistiques d\'utilisation des index (pg_stat_user_indexes)', async () => {
    ...
    // Puis verifiez que nos index existent dans les statistiques
    //
    // Indice : SELECT indexrelname, idx_scan, idx_tup_read
