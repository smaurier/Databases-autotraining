...
// ---------------------------------------------------------------------------
async function reserveWithRetry(c, roomId, eventId, startTime, endTime, user, maxRetries = 3) {
  let attempts = 0;
  ...
  while (attempts < maxRetries) {
    ...
    try {
      ...
      const retryable = err.code === '23P01' || err.code === '40001' || err.code === '40P01';
      ...
      return { success: false, attempts, error: err.message, code: err.code };
    }
  }
